...
import org.studyeasy.SpringStarter.security.util.AppUtil;
import org.studyeasy.SpringStarter.security.util.email.EmailDetails;
...
public class AccountController {
    ...
    public String reset_password(@RequestParam("email") String _email, RedirectAttributes attributes,Model model){
        ...
        if(optional_account.isPresent()){
            ...
            accountService.save(account);
            String reset_message="This is the reset password link: "+site_domain+"chnage-password?token="+reset_token;
